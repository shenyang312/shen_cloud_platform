package com.shen.cloud.mapper;

import com.alibaba.fastjson.JSON;
import com.shen.cloud.util.ZmException;
...
public class MapperUtil {
     ...
     * @since JDK 1.8
     */
    public static void setExampleCriteria(Class t, Example.Criteria criteria, Map<String, Object> params, String... fileds) throws ZmException {
...
//                        Object fieldValue = f.get(t);
                        ...
                        String logic = "";
                        if (ZmUtil.isNotEmpty(fieldValue)) {
...
/*
                        ...
                        } else if (!ObjectUtils.equals(fieldValue, null) && ZmUtil.isNotEmpty(logic)) {
                            switch (logic) {
                                case ">":
                    ...
                    throw new ZmException("200", "setExampleCriteria exception.");
                }
            }
        }
    }
